...
📚 **Full API Documentation:** [https://docs.apiverve.com/ref/liturgicalcalendar](https://docs.apiverve.com/ref/liturgicalcalendar)

---

## Use Cases

Common use cases for the Liturgical Calendar API:

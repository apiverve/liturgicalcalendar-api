...
const (
	baseURL        = "https://api.apiverve.com/v1/liturgicalcalendar"
	defaultTimeout = 30 * time.Second
)

// Client is the Liturgical Calendar API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Liturgical Calendar API client.
...
// Execute makes a request to the Liturgical Calendar API with typed parameters.
//

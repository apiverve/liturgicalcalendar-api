...
class liturgicalcalendarWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/liturgicalcalendar');
        }
        ...
        this.baseURL = 'https://api.apiverve.com/v1/liturgicalcalendar';

        // Validation rules for parameters (generated from schema)
        this.validationRules = {"month":{"type":"integer","required":false,"min":1,"max":12},"year":{"type":"integer","required":false,"min":1900,"max":2100}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/liturgicalcalendar`);
        }
    }
...
module.exports = liturgicalcalendarWrapper;

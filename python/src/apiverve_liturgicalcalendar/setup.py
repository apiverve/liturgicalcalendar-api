...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/liturgicalcalendar',
        'Source': 'https://github.com/apiverve/liturgicalcalendar-api',
        'Bug Tracker': 'https://github.com/apiverve/liturgicalcalendar-api/issues'
    },
    classifiers=[

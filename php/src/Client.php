...
namespace APIVerve\Liturgicalcalendar;
...
/**
 * Client for the Liturgical Calendar API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/liturgicalcalendar?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/liturgicalcalendar';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\LiturgicalcalendarClient] {$message}\n";
        }
    }
}

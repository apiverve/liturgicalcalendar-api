...
{
    class LiturgicalCalendarExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/liturgicalcalendar";

        /// <summary>
        /// Make a GET request to the Liturgical Calendar API
        /// </summary>
        static async Task<JsonDocument> CallLiturgicalCalendarAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;month&quot;] &#x3D; 02, [&quot;year&quot;] &#x3D; 2025 };
        ...
        {
            Console.WriteLine("📤 Calling Liturgical Calendar API...\n");

            var result = await CallLiturgicalCalendarAPI();

# Liturgical Calendar Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:liturgicalcalendar-api:1.1.12'
}
```
...
```java
import com.apiverve.liturgicalcalendar.LiturgicalCalendarAPIClient;
import com.apiverve.liturgicalcalendar.APIResponse;
import com.apiverve.liturgicalcalendar.APIException;

// Initialize the client
LiturgicalCalendarAPIClient client = new LiturgicalCalendarAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/liturgicalcalendar](https://docs.apiverve.com/ref/liturgicalcalendar)
...
- **Documentation:** [https://docs.apiverve.com/ref/liturgicalcalendar](https://docs.apiverve.com/ref/liturgicalcalendar)
- **Issues:** [GitHub Issues](https://github.com/apiverve/liturgicalcalendar-api/issues)
